...
router.post('/new', async(ctx, next) => ArticleController.new(ctx));
router.post('/update/:articleNumber', async(ctx) => ArticleController.update(ctx));
...
router.get('/create', async(ctx) => ArticleController.create(ctx));
